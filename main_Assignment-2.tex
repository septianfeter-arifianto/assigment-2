...
\begin{itemize}
    ...
    \item Anotasi Dinamis: Menggunakan fungsi plt.text untuk menampilkan nilai numerik t = $32.5^\circ C$ secara langsung di dalam grafik, memberikan kejelasan instan bagi pembaca
    \item Simbol Matematika: Label sumbu Y diformat menggunakan sintaks LaTeX $\mu_s(t)$ untuk menampilkan simbol standar fuzifikasi secara profesional.
\end{itemize}
